...
class IbmDb2Check(AgentCheck):
    ...
    def query_database(self, connection, tags):
        ...
        self.check_database_status(result['db_status'], tags)
    ...
    def check_database_status(self, status, tags):
        # https://www.ibm.com/support/knowledgecenter/SSEPGG_11.1.0/com.ibm.db2.luw.admin.mon.doc/doc/r0001156.html
        self.service_check(self.SERVICE_CHECK_STATUS, status_to_service_check(status), tags=tags)
